    ...
    $(".search-suggest").mouseover(function () {
        ...
        $.ajax({
            ...
            success: function (e) {
                ...
                //0 == e.status && ($("#error-message").show(), $("#error-message").text(e.message), 
                //$("#login-submit").removeAttr("disabled"), $("#login-loading").hide()), 1 == e.status && window.location.reload()
            }, 
            error: function(e) {
                var errors = $.parseJSON(e.responseText);
                $("#error-message").show();
                for (var key in errors) $("#error-message").text(errors[key]);
                $("#login-submit").removeAttr("disabled"), $("#login-loading").hide();
            }
        }), e.preventDefault()
        ...
        $.ajax({
            ...
            error: function(e) {
                ...
                for (var key in errors["errors"]) $("#register-error-message").text(errors["errors"][key][0]);
        ...
        $.ajax({
            ...
            success: function (e) {
                ...
                $("#forgot-success-message").text("Password reset successfully sent, please check your email.");
            }, 
            error: function(e) {
                var errors = $.parseJSON(e.responseText);
                $("#forgot-error-message").show();
                $("#forgot-success-message").hide();
                for (var key in errors) $("#forgot-error-message").text(errors[key]);
                $("#forgot-submit").removeAttr("disabled"), $("#forgot-loading").hide();
            }
        }), e.preventDefault()
