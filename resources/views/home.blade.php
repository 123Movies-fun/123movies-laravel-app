        ...
        <div class="container">
                ...
                <div id="slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" style="background-image: url(/images/maxresdefault.jpg);">
                            <a href="https://123movies.fun/film/split-2017.24658/" class="slide-link" title="Split (2017)"></a> <span class="slide-caption"> <h2>Split (2017)</h2> <p class="sc-desc">Kevin, a man with at least 23 different personalities, is compelled to abduct three teenage girls. As they are held captive, a final personality - "The Beast" - begins to materialize.</p> <div class="slide-caption-info"> <div class="block"><strong>Genre:</strong> <a href="/genre/horror" title="Horror">Horror</a>, <a href="/genre/thriller" title="Thriller">Thriller</a> </div> <div class="block"><strong>Duration:</strong> min</div> <div class="block"><strong>Release:</strong> 2017</div> <div class="block"><strong>IMDb:</strong> 7.5</div> </div> <a href="https://123movies.fun/film/split-2017.24658/watching.html"> <div class="btn btn-successful mt20">Watching</div> </a> </span> </div>
                    </div>
                                ...
                                <div role="tabpanel" class="tab-pane in fade active" id="tn-news">
                                    <ul class="tn-news">
                                        <li>
                                            ...
                                            <div class="tnc-info">
                                                <h4> <a href="https://123movies.fun/articles/view/review-storks--an-uneasy-return-to-delivering-babies/5" title="Review: ‘Storks,’ an Uneasy Return to Delivering Babies">Review: ‘Storks,’ an Uneasy Return to Delivering Babies</a></h4> </div>
                                            <div class="clearfix"></div>
                                        </li>
 
                                        <li class="view-more"> <a href="https://123movies.fun/articles/news"> View more <i class="fa fa-chevron-circle-right"></i></a> </li>
                                    </ul>
                                </div>
            ...
            <div class="main-content">
                <div class="movies-list-wrap mlw-topview mt20">
                    <div class="ml-title"> <span class="pull-left">Suggestion <i class="fa fa-chevron-right ml10"></i></span> <a href="/filter/all" class="pull-right cat-more">View more »</a>
                ...
                <div class="movies-list-wrap mlw-latestmovie">
                    <div class="ml-title"> <span class="pull-left">Latest Movies <i class="fa fa-chevron-right ml10"></i></span> <a href="/filter/movies" class="pull-right cat-more">View more »</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="movies-list movies-list-full tab-pane in fade active">
                        ...
                        <div data-movie-id="{{ $movie->id }}" class="ml-item">
                            <a href="{{$movie->watchUrl()}}" data-url="/imdb/info?id={{$movie->id}}" class="ml-mask jt" title="{{$movie->title }} ({{$movie->year}})"> <span class="mli-quality">{{$movie->bestQuality()}}</span> <img data-original="{{$movie->PosterImageUrl() }}" class="lazy thumb mli-thumb" alt="{{$movie->title }} ({{$movie->year}})"> <span class="mli-info"><h2>{{$movie->title }} ({{$movie->year}})</h2></span> </a>
                        </div>
                        @endforeach
                ...
                <div class="movies-list-wrap mlw-featured">
                    <div class="ml-title"> <span class="pull-left">Latest TV-Series <i class="fa fa-chevron-right ml10"></i></span> <a href="/filter/tv" class="pull-right cat-more">View more »</a>
                        <div class="clearfix"></div>
                    </div>
                    <div class="movies-list movies-list-full">
                             @foreach($tvs as $tv) 
                        <div data-movie-id="{{ $tv->id }}" class="ml-item">
                            <a href="{{$tv->watchUrl()}}" data-url="/imdb/info?id={{$tv->id}}" class="ml-mask jt" title="{{$tv->title }} ({{$tv->year}})"> <span class="mli-eps">Eps<i>{{$tv->highestEp()}}</i></span> <img data-original="{{$tv->PosterImageUrl() }}" class="lazy thumb mli-thumb" alt="{{$tv->title }} ({{$tv->year}})"> <span class="mli-info"><h2>{{$tv->title }} ({{$tv->year}})</h2></span> </a>
                        </div>
                        @endforeach
                        <div class="clearfix"></div>
                    </div>
                ...
                <div class="movies-list-wrap mlw-requested">
                    <div class="ml-title"> <span class="pull-left">Requested <i class="fa fa-chevron-right ml10"></i></span> <a href="/movie/filter/tv" class="pull-right cat-more">View more »</a> </div>
                    <div class="clearfix"></div>
                    <div class="movies-list movies-list-full">
