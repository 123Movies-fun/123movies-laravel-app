            ...
            <div class="main-content">
                <div class="movies-list-wrap mlw-topview mt20">
                    ...
                    <div class="movies-list-wrap mlw-latestmovie">
                        <div class="ml-title"> <span class="pull-left">{{$genre->genre}} <i class="fa fa-chevron-right ml10"></i></span> <a href="https://123movies.film/movie/filter/movie" class="pull-right cat-more">View more »</a>
